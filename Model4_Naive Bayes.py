...
a = pd.read_csv('strat_clean.csv') # dataset file
features = ['ADT_029','PERCENT_ADT_TRUCK_109','recons','SVCYR','SVCYR_sq'] # input parameters
...
# Training the model
# reconstruct is a categorical variable

clf = mnb.MixedNB(categorical_features=[2]) 
...
plt.title("Model 4 - Naive Bayes with variables used in class")
plt.grid()
plt.show()
...
make_confusion_matrix(cnf_matrix, group_names=labels,
                      ...
                      title="Model 4 - Naive Bayes with variables used in class")